...
Court.prototype.startPlay=function(){null==this.game&&(this.game=new Game(this));window.hideMessage();console.log("Starting play");this.paused=!1;this.getCollisons()};Court.prototype.pausePlay=function(){this.paused=!0;console.log("Play paused");window.message(window.court.pausedMessage)};Court.prototype.restartPlay=function(){this.paused=!1;window.hideMessage();console.log("Play restarted");this.getCollisons()};Court.prototype.togglePlay=function(){this.paused?this.restartPlay():this.pausePlay()};
